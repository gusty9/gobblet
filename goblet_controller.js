class GobletController {
    ...
    on_board_space_click(index) {
        if (this.selected.selected === true) {
            ...
            if (this.game_board.board_spaces[index].get_top() === this.current_player) {
    ...
    on_reserve_space_click(index) {
        ...
        if (this.selected.selected || this.game_board.reserve_spaces[index].get_top() !== this.current_player) {
            return;
        }
        this.selected.selected = true;
